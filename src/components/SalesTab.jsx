...
// import { Download, Search, Filter, Layers, Wallet } from "lucide-react";
...
//           </div>
//           <div>
//             <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Filtered Revenue</p>
...
//           </div>
//           <div>
//             <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Students Found</p>
...
//           className="flex items-center justify-center space-x-3 bg-black text-white p-4 rounded-2xl hover:bg-gray-800 transition active:scale-95 sm:col-span-2 md:col-span-1 shadow-lg"
//         >
//           <Download size={20} /> 
...
//           <input 
//             className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-black transition"
...
//           <select 
//             className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-xl outline-none appearance-none font-bold text-sm cursor-pointer"
...
//                     <div className="text-[10px] text-gray-400 uppercase font-black">{p.department}</div>
//                   </td>
//                   <td className="p-5 font-mono text-sm text-gray-600">{p.matricNo}</td>
//                   <td className="p-5 font-bold text-gray-700">{p.level}L</td>
//                   <td className="p-5 text-sm font-semibold">{p.manual.title}</td>
//                   <td className="p-5">
//                     <span className={`px-3 py-1 rounded-full text-[10px] font-black ${p.status === 'paid' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
...
//           </table>
//           {filtered.length === 0 && (
//             <div className="p-20 text-center text-gray-300 font-bold italic">No matching records found.</div>
//           )}
//         </div>
//       </div>
//     </div>
