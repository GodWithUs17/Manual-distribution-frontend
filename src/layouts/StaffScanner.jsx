...
//   useEffect(() => {
//     // 1. If we aren't in scanning mode, don't do anything
//     if (!isScanning) return;
//     isProcessing.current = false;

//     // 2. Initialize the direct camera controller
...
//               try {
//                 setIsScanning(false);
//                 await html5QrCode.stop(); // Turn off camera immediately
...
//     // 4. Cleanup: Shuts down the camera if the staff leaves the tab
//     return () => {
